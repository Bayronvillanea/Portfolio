...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b text-white">
      <h2 className="font-serif text-5xl font-bold mb-4 text-center mt-10">Contact Me</h2>
      <p className="text-lg mb-6 text-center">Feel free to reach out to me via email:</p>
      <a
